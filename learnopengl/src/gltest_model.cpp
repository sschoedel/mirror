...
int main()
{
    ...
    for (int i=0; i<max_mirrors; i++) {
        Model model("../models/mirrorbacking/mirrorbacking.obj",
            glm::vec3(0.0f, 0.0f, 0.0f), // translation
            glm::vec3(1.0f, 0.3f, 0.5f), // rotation vector
            0,                           // rotation angle
            0.01f);                       // scale
        models.push_back(model);
    }

    models[1].setTranslation(glm::vec3(0.0f, 1.0f, 0.0f));
